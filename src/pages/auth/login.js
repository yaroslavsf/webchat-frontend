...
export default function login() {
    return (
        <div className='justify-center flex  dark:bg-gray-700 h-screen w-screen items-center'>
            <div className="bg-white dark:bg-gray-800 rounded-md py-2 px-8 md:drop-shadow-2xl w-full max-w-lg">
                <h1 className='w-full font-bold text-2xl text-center mt-6'>Welcome back 👋</h1>
                <h2 className="mb-3 mt-1 text-gray-500 font-semibold text-center">Log in to web.chat</h2>
                ...
                <button type="button" class=" mt-5 mb-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 w-full">Continue</button>
