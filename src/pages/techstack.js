        ...
        <main className='flex justify-center items-center w-screen h-screen bg-gray-50 dark:bg-gray-700'>
            <div className='bg-white dark:bg-gray-800 rounded-md drop-shadow-2xl'>
                <div className="flex justify-end">
                    <button type="button" class="py-2.5 px-5 me-2 mt-2 text-sm font-medium text-gray-900 focus:outline-none bg-white dark:bg-gray-700 rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700  dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                ...
                <div className="py-2 px-8">
                    ...
                    <button type="button" class=" mt-5 mb-8 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 w-full">Continue</button>
                </div>
            </div>
        </main>
    )
